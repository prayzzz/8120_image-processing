 ...
 */
public class Calculation_Difference implements PlugInFilter
{
    ...
    public void run(ImageProcessor imageProcessor)
    {
        ...
        GenericDialog gd = new GenericDialog("Difference");
        ...
        ImagePlus newImage = new ImageCalculator().run("Difference create", image1, image2);
        newImage.show();
    }
}
